<%@ Page Title="Change Password" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true"
    CodeBehind="ChangePassword.aspx.cs" Inherits="Rezerwacje.Account.ChangePassword" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <p>
       Wypełnij formularz poniżej aby zmienić hasło
    </p>
    <p>
       Nowe hasło musi mięć minimum <%= Membership.MinRequiredPasswordLength %> znaków.
    </p>
        ...
        <ChangePasswordTemplate>
            ...
            <div class="accountInfo">
                <fieldset class="changePassword">
                    <legend>Informacje konta</legend>
                    <p>
                ...
                <p class="submitButton">
                    ...
                    <asp:Button ID="ChangePasswordPushButton" runat="server" CommandName="ChangePassword" Text="Zmień hasło" 
                         ValidationGroup="ChangeUserPasswordValidationGroup"/>
                </p>
            </div>
        </ChangePasswordTemplate>
